    ...
    <header className="sticky top-0 z-40 bg-slate-950/85 backdrop-blur-xl border-b-2 border-slate-800/60">
      <div className="max-w-lg mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-linear-to-br from-amber-500 to-red-600 flex items-center justify-center shadow-lg shadow-amber-900/30">
          ...
          <div>
            ...
            <p className="text-[9px] text-slate-600 tracking-[0.15em] uppercase">
              Sapeurs-Pompiers
            </p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          {dbCount !== undefined && (
            <span className="text-[10px] text-slate-600 font-medium hidden min-[380px]:inline">
